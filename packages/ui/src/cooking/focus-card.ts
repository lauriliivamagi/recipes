...
import { scaleQuantity } from '@recipe/domain/scaling/scale.js';
import { formatQuantity } from '@recipe/domain/scaling/format.js';
import type { Operation, Ingredient } from '@recipe/domain/recipe/types.js';
